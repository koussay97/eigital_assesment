...
class UserClass {
  ...
  /// visits
  final int totalVisits; /// sum of all visits
  ...
  UserClass(
      {required this.email,
        ...
        this.birthday,
        this.customerSince,
        this.image}):totalVisits = canceledVisits+noShowVisits+upcomingVisits;
  ...
  UserClass copyWith({
    ...
    return UserClass(
      ...
      loyaltyPointsAvailable: loyaltyPointsAvailable ?? this.loyaltyPointsAvailable,
...
class OnlineReviewModel {
  ...
  OnlineReviewModel({required this.reviewMessage,required  this.reviewImage,required this.reviewRating});
}